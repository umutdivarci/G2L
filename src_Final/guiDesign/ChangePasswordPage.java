...
public class ChangePasswordPage extends JFrame {
	...
	*/
	 ...
	 * Create the frame.
	 */
	public ChangePasswordPage(Account account) {
		...
		btnSignUpHere.setIcon(new ImageIcon(ChangePasswordPage.class.getResource("/icons/809922_arrows_512x512_55x55.png")));
		...
		txtWelcomeTo.setText("Change Password");
		...
		JFormattedTextField enterNewPassword = new JFormattedTextField();
		enterNewPassword.setHorizontalAlignment(SwingConstants.LEFT);
		enterNewPassword.setFont(new Font("Tahoma", Font.PLAIN, 14));
		enterNewPassword.setBounds(232, 141, 202, 30);
		contentPane.add(enterNewPassword);
		
		
		txtConfirmNewPassword = new JTextField();
		txtConfirmNewPassword.setText("Confirm new password");
		...
		txtConfirmNewPassword.setBounds(91, 221, 131, 19);
		...
		JFormattedTextField confirmNewPassword = new JFormattedTextField();
		confirmNewPassword.setHorizontalAlignment(SwingConstants.LEFT);
		confirmNewPassword.setFont(new Font("Tahoma", Font.PLAIN, 14));
		confirmNewPassword.setBounds(232, 214, 202, 30);
		contentPane.add(confirmNewPassword);
		
		JButton btnSave = new JButton("Save");
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// If entered passwords match, update the passwords accordingly.
				if ( enterNewPassword.getText().equals(confirmNewPassword.getText()))
				{
					account.setPassword(enterNewPassword.getText());
					errorText.setForeground(new Color(34, 139, 34));
					errorText.setText("Your password is succesfully updated.");
					errorText.setVisible(true);
				}
				
				else
				{
					errorText.setText("The passwords entered do not match!");
					errorText.setVisible(true);
				}
			}
		});
