...
public class PatientMainPage extends JFrame {
	...
	*/
	...
	public PatientMainPage(Patient patient) {
		...
		JButton btnNewButton = new JButton("Update My Medical Data");
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Health Tracker", "My Medical Records", "Quarantine Status", "My Dietary Plan", "My Exercise Plan"}));
		comboBox.setFont(new Font("Tahoma", Font.BOLD, 15));
		comboBox.setBackground(new Color(34, 139, 34));
		comboBox.setForeground(Color.WHITE);
		comboBox.setToolTipText("");
		comboBox.setBounds(87, 292, 220, 48);
		comboBox.setSelectedItem("My Health Conditions");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (s) {//check for a match
                    ...
                    case "My Dietary Plan":
                    	DietPlanPage frame4 = new DietPlanPage(patient);
                    ...
                    case "My Exercise Plan":
        				ExercisePlanPage frame5 = new ExercisePlanPage(patient);
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Ankara Hospital", "Liv Hospital", "Bilkent Health Center"}));
        ...
        ActionListener cbActionListener1 = new ActionListener() {//add actionlistner to listen for change
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (s) {//check for a match
                    ...
                    case "Liv Hospital":
        				AppointmentPage frame2 = new AppointmentPage( a.hospital, patient);
        				frame2.setVisible(true);
        				Window win2 = SwingUtilities.getWindowAncestor(contentPane);
        				win2.dispose();
                        break;
                    ...
                    case "Bilkent Health Center":
        				AppointmentPage frame3 = new AppointmentPage( a.hospital, patient);
        				frame3.setVisible(true);
        				Window win3 = SwingUtilities.getWindowAncestor(contentPane);
        				win3.dispose();
                        break;
		...
		lblNewLabel.setIcon(new ImageIcon(PatientMainPage.class.getResource("/icons/profilSon_150x150.png")));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (s) {//check for a match
                    case "Change Password":
        				ChangePasswordPage frame1 = new ChangePasswordPage(patient);
        				frame1.setVisible(true);
        				Window win1 = SwingUtilities.getWindowAncestor(contentPane);
        				win1.dispose();
                        break;
                    ...
                    case "Change E-mail":
        				ChangeMailPage frame2 = new ChangeMailPage(patient);
        				frame2.setVisible(true);
        				Window win2 = SwingUtilities.getWindowAncestor(contentPane);
        				win2.dispose();
                        break;
		...
		ActionListener cbActionListener3 = new ActionListener() {//add action listener to listen for change
            @Override
            public void actionPerformed(ActionEvent e) {
		...
		lblNewLabel_3.setIcon(new ImageIcon(PatientMainPage.class.getResource("/icons/icon main page.png")));
