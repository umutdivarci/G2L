...
public class DietPlan {
    ...
    //constants
    final String[] breakfastSuggestion = {"One grapefruit, two poached eggs, two slices of whole-grain toast,\r\n a cup of low-fat milk, a cup of black coffee", "1 cup cereal, 1 cup whole milk, 1 fruit, 8 ounce juice", "Three eggs scrambled with two ounces cheese, two slices of whole-grain bread,\r\n fruit smoothie"};
    final String[] lunchSuggestion = {"Baked/Roasted chicken breast, a large serving of garden salad,\r\n a glass of water", "1 slice pizza with meat, a side salad, a glass of juice", "Macaroni and cheese: 1 cup cooked pasta with 2 ounces cheese,\r\n 1 cup cooked vegetable, 8 ounces juice"};
