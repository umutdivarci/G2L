...
public class PharmacySignUpPage extends JFrame {
	...
	public PharmacySignUpPage() {
		...
		txtSignUp.setText("Sign Up for an Pharmacy Account");
		...
		comboBox.setBounds(232, 355, 202, 30);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Pharmacy pharmacy = new Pharmacy( enterUsername.getText(), enterPassword.getText(), enterEmail.getText(),
				enterName.getText(), comboBox.getSelectedItem().toString());
