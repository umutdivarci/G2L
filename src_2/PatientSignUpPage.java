...
public class PatientSignUpPage extends JFrame {
	...
	public PatientSignUpPage() {
		...
		txtSignUp.setText("Sign Up as a Patient");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Patient patient = new Patient( enterUsername.getText(), enterPassword.getText(), enterEmail.getText(),
						Long.parseLong(enterID.getText()), comboBox.getSelectedItem().toString(), enterName.getText());
