...
public class PharmacyMainPage extends JFrame {
	...
	public PharmacyMainPage( Pharmacy pharmacy) {
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Pharmacy Records", "Available Resources"}));
		...
		txtUmutDivarc.setText("Ankara Pharmacy");
		...
		lblNewLabel_3.setIcon(new ImageIcon(HospitalMainPage.class.getResource("/icons/icon main page.png")));
