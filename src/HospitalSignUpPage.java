...
public class HospitalSignUpPage extends JFrame {
	...
	public HospitalSignUpPage() {
		...
		txtSignUp.setText("Sign Up for an Hospital Account");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Hospital hospital = new Hospital( enterUsername.getText(), enterPassword.getText(), enterEmail.getText(),
