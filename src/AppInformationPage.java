...
public class AppInformationPage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AppInformationPage frame = new AppInformationPage();
